...
class testDatasetAudio(data.Dataset):
    def __init__(self, config=None, mode='test'):
    ...
    def __getitem__(self, index):
        ...
        global_label = self.global_label_list[index]
        label = self.label_list[index]
        

        return audio, label, global_label, 
    ...
    def collate_fn(batch):
        ...
        """
        # Separate the image, label, label_spe, landmark, and mask tensors
        audios, labels, labels_spe = zip(*batch)
