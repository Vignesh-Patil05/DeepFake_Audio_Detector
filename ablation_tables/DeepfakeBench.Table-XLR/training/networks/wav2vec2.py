...
import sys
sys.path.append('/face/hnren/3.SSL/codes/research_proposal/audio_deepfake_detection/codes/TABLE/fairseq/')
...
@BACKBONE.register_module(module_name="xlsr")
class Wav2Vec2Model(BaseFairseqModel):
    ...
    def features(
        self, source, padding_mask, mask=False, layer=None, corpus_key=None, inference=False
    ):
        res = self.forward(
            source,
            padding_mask,
